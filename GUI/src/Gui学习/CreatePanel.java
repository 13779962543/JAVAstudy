...
//        //向顶部面版添加背景图片
//        ImageIcon image=new ImageIcon("GUI/src/images/back.jpg");
//        JLabel background=new JLabel(image);
//        //设置背景图片的位置和尺寸
//        background.setBounds(0,0,426,image.getIconHeight());
//        panel.add(background);
//        //在顶部JPanel面板右上角添加一个退出按钮
//        JButton out=new JButton(new ImageIcon("GUI/src/images/close_normal.jpg"));
//        out.setBounds(403,0,26,26);
//        //设置鼠标移动到退出按钮时更改图片
//        out.setRolloverIcon(new ImageIcon("GUI/src/images/close_hover.jpg"));
//        //取消按钮边框效果
...
//        //向左侧面板添加背景图片
//        ImageIcon image=new ImageIcon("GUI/src/images/qq.jpg");
//        JLabel background=new JLabel(image);
...
//       JPanel panel=new JPanel();
//       panel.setLayout(null);
//       //创建一个JComboBox下拉框组件，并初始化qq
//        String str[]={"1507543567","987654321","1314520888"};
...
//        panel.add(jpaCenter);
//        //创建ImageIcon小键盘图片组件，并加入到密码框组件中
//        ImageIcon image=new ImageIcon("GUI/src/images/keyboard.jpg");
...
//        regeist.setForeground(new Color(100,149,239));
...
//     panel.setLayout(null);
//     //创建左下角多人登录图标组件
//        JButton jble=new JButton(new ImageIcon("GUI/src/images/single_normal.jpg"));
//        jble.setPreferredSize(new Dimension(40,40));
//        jble.setFocusPainted(false);
//        jble.setRolloverIcon(new ImageIcon("GUI/src/images/single_down.jpg"));
...
//        //创建底部中间登录图标组件
//        ImageIcon image=new ImageIcon("GUI/src/images/login_normal.jpg");
...
//        jb.setRolloverIcon(new ImageIcon("GUI/src/images/login_hover.jpg"));
//        //创建右下角二维码登录图标组件
//        JButton jbri=new JButton(new ImageIcon("GUI/src/images/right_normal.jpg"));
//        jbri.setBounds(380,10,40,40);
//        jbri.setFocusPainted(false);
//        jbri.setBorderPainted(false);
//        jbri.setContentAreaFilled(false);
//        jbri.setRolloverIcon(new ImageIcon("GUI/src/images/right_hover"));
//        jbri.setToolTipText("二维码登录");
//        //为登录按钮注册监听器，后天检测qq账号，密码是否正确
