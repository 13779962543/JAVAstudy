package movieapp.run;

import movieapp.bean.Business;
import movieapp.bean.Customer;
import movieapp.bean.Movie;
import movieapp.bean.User;
...
public class MovieSystem {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger("movieapp.run.MovieSystem.class");
    ...
    /**
      商家进行电影上架
     Map<movieapp.bean.Business , List<movieapp.bean.Movie>> ALL_MOVIES
     u1 = [p1,p2,p3]
     u2 = [p1,p2,p3]
     */
    private static void addMovie() {
        ...
        while (true) {
            try {
                ...
                String stime  = SYS_SC.nextLine();
            // public movieapp.bean.Movie(String name, String actor, double time, double price, int number, Date startTime)        // 封装成电影对象 ，加入集合movices中去
